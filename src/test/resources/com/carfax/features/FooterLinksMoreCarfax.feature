Feature: : Footer link for More Carfax links
  @morecarfax @smoke  @fl

  Scenario: About Carfax footer link
  ...
  Scenario: Press Room footer link
    Given I am on main Carfax page
    And I navigate to Find a Used Car page
    And I scroll down to footer links
  ...
  Scenario:  Carfax for Dealers footer link
    Given I am on main Carfax page
    And I navigate to Find a Used Car page
    And I scroll down to footer links
  ...
  Scenario: CARFAX Banking & Insurance Group footer link
    Given I am on main Carfax page
    And I navigate to Find a Used Car page
    And I scroll down to footer links
